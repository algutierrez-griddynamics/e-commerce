package org.ecommerce.enums;
    ...
    public enum Error {
        ...
        INVALID_BILLING_INFORMATION("The billing information provided is invalid."),
        INVALID_SHIPPING_INFORMATION("The shipping information provided is invalid."),
        UNEXPECTED_ORDER_CREATION("An unexpected error occurred while creating the order.");
